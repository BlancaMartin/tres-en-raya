...
var author$project$Game$label = elm$html$Html$Attributes$attribute('data-label');
var author$project$Game$HumanMove = function (a) {
	return {$: 'HumanMove', a: a};
};
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var author$project$Game$positionColor = function (position) {
	switch (position) {
		case 'X':
			return A2(elm$html$Html$Attributes$style, 'color', 'red');
		case 'O':
			return A2(elm$html$Html$Attributes$style, 'color', 'blue');
		default:
...
var author$project$Game$viewPosition = F2(
	function (index, position) {
		return A2(
			...
			_List_fromArray(
				[
					author$project$Game$positionColor(position),
					elm$html$Html$Events$onClick(
					author$project$Game$HumanMove(index))
				]),
			_List_fromArray(
				[
...
var author$project$Game$viewRow = function (row) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		A2(
			...
			function (_n0) {
				var index = _n0.a;
				var position = _n0.b;
				return A2(author$project$Game$viewPosition, index, position);
			},
			row));
};
var elm$html$Html$table = _VirtualDom_node('table');
var author$project$Game$viewBoard = function (board) {
	return A2(
		elm$html$Html$table,
		_List_fromArray(
			[
				author$project$Game$label('board')
			]),
		A2(
			elm$core$List$map,
			function (row) {
				return author$project$Game$viewRow(row);
			},
			A2(
				elm_community$list_extra$List$Extra$groupsOf,
				author$project$Board$size(board),
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Game$label('human-vs-human')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						author$project$Game$label('human-vs-random')
					]),
				_List_fromArray(
					[
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		init: author$project$Game$init,
		subscriptions: elm$core$Basics$always(elm$core$Platform$Sub$none),
		update: author$project$Game$update,
		view: author$project$Game$view
	});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Game.Msg","aliases":{},"unions":{"Game.Msg":{"args":[],"tags":{"NoOp":[],"RestartGame":[],"HumanVsHuman":[],"HumanVsRandom":[],"HumanVsSuper":[],"MakeMove":["Basics.Int"],"RandomMove":[],"SuperMove":[],"HumanMove":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));