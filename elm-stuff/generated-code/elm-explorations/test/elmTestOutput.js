...
var author$project$Board$emptyPosition = '';
...
var author$project$Board$full = function (board) {
	return !A2(
		elm$core$List$any,
		function (n) {
			return _Utils_eq(n, author$project$Board$emptyPosition);
...
var author$project$Board$init = function (length) {
	return A2(elm$core$List$repeat, length * length, author$project$Board$emptyPosition);
};
...
var author$project$Board$sameMark = F2(
	function (line, player) {
		return A2(
			elm$core$List$all,
			function (n) {
				return _Utils_eq(n, player.mark);
			},
			line);
	});
...
var author$project$Board$left_diagonal = function (rowLines) {
	return A2(
		elm$core$List$map,
		function (mark) {
			return A2(elm$core$Maybe$withDefault, author$project$Board$emptyPosition, mark);
		},
		A2(
			elm$core$List$map,
			function (_n0) {
				var index = _n0.a;
				var row = _n0.b;
				return A2(elm_community$list_extra$List$Extra$getAt, index, row);
			},
			A2(elm$core$List$indexedMap, elm$core$Tuple$pair, rowLines)));
};
var author$project$Board$right_diagonal = function (rowLines) {
	return author$project$Board$left_diagonal(
		elm$core$List$reverse(rowLines));
};
var elm$core$Basics$sqrt = _Basics_sqrt;
var elm$core$Basics$toFloat = _Basics_toFloat;
var elm$core$Basics$truncate = _Basics_truncate;
var author$project$Board$size = function (board) {
	return elm$core$Basics$sqrt(
		elm$core$List$length(board)) | 0;
};
...
var author$project$Board$rows = function (board) {
	return A2(
		elm_community$list_extra$List$Extra$groupsOf,
		author$project$Board$size(board),
		board);
};
var elm$core$Basics$append = _Utils_append;
var author$project$Board$winningLines = function (board) {
	var rowLines = author$project$Board$rows(board);
	return _Utils_ap(
		rowLines,
		_Utils_ap(
			author$project$Board$columns(rowLines),
			_Utils_ap(
				_List_fromArray(
					[
						author$project$Board$left_diagonal(rowLines)
					]),
				_List_fromArray(
					[
						author$project$Board$right_diagonal(rowLines)
					]))));
};
var author$project$Board$isWinner = F2(
	function (player, board) {
		return A2(
			...
			A2(
				elm$core$List$map,
				function (line) {
					return A2(author$project$Board$sameMark, line, player);
				},
				author$project$Board$winningLines(board)));
	});
...
var author$project$Board$register = F3(
	function (position, player, board) {
		return A3(
...
var author$project$Player$Player = F2(
	function (mark, typePlayer) {
		return {mark: mark, typePlayer: typePlayer};
	});
...
var author$project$BoardTest$suite = A2(
	...
	_List_fromArray(
		[
			...
			function (_n0) {
				var board = author$project$Board$init(3);
				return A2(
			...
			A2(
			elm_explorations$test$Test$test,
			'register a mark in a position in a board',
			function (_n1) {
				var player = A2(
				...
				return A2(
					...
					_List_fromArray(
						['', '', '', '', 'X', '', '', '', '']),
					A3(author$project$Board$register, 4, player, board));
			}),
			A2(
			elm_explorations$test$Test$test,
			'board is not full',
			function (_n2) {
				var player = A2(
					...
					elm$core$Maybe$Just(author$project$Player$Human));
				var board = author$project$Board$init(3);
				var markedBoard = A3(author$project$Board$register, 4, player, board);
				return A2(
					elm_explorations$test$Expect$equal,
					false,
					author$project$Board$full(markedBoard));
			}),
			A2(
			elm_explorations$test$Test$test,
			'board is full',
			function (_n3) {
				var fullBoard = _List_fromArray(
					['X', 'O', 'X', 'O', 'X', 'O', 'X', 'O', 'X']);
				return A2(
					elm_explorations$test$Expect$equal,
					true,
					author$project$Board$full(fullBoard));
			}),
			A2(
			elm_explorations$test$Test$test,
			'gets the available positions of the board',
			function (_n4) {
				var board = _List_fromArray(
					['X', '', 'X', '', 'X', '', 'X', 'O', 'X']);
				return A2(
					elm_explorations$test$Expect$equal,
					_List_fromArray(
						[1, 3, 5]),
					author$project$Board$availablePositions(board));
			}),
			A2(
			elm_explorations$test$Test$test,
			'X is a winner',
			function (_n5) {
				...
				return A2(
					elm_explorations$test$Expect$equal,
					true,
					A2(author$project$Board$isWinner, player1, board));
			}),
			A2(
			elm_explorations$test$Test$test,
			'O is not a winner.',
			function (_n6) {
				...
				return A2(
					elm_explorations$test$Expect$equal,
					false,
					A2(author$project$Board$isWinner, player2, board));
			})
		]));
		...
		switch (playerType.$) {
			...
			case 'Random':
				return _Utils_update(
					player,
					{
						typePlayer: elm$core$Maybe$Just(author$project$Player$Random)
					});
			default:
				return _Utils_update(
					player,
...
var author$project$Game$setMode = F3(
	function (type1, type2, game) {
		var currentPlayer = game.currentPlayer;
		var opponent = game.opponent;
		return _Utils_update(
			game,
...
var author$project$PlayerTest$suite = A2(
	...
	_List_fromArray(
		[
			...
			function (_n0) {
				var player = A2(author$project$Player$Player, 'O', elm$core$Maybe$Nothing);
				return A2(
					elm_explorations$test$Expect$equal,
					{
						mark: 'O',
...
var author$project$Test$Generated$Main1619197617$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/miss.merce/Workspace/Elm/tres-en-raya/tests/BoardTest.elm', '/Users/miss.merce/Workspace/Elm/tres-en-raya/tests/GameTest.elm', '/Users/miss.merce/Workspace/Elm/tres-en-raya/tests/PlayerTest.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 242743595906703
	},
	elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'GameTest',
				_List_fromArray(
					[author$project$GameTest$suite])),
				A2(
				elm_explorations$test$Test$describe,
				'PlayerTest',
				_List_fromArray(
					[author$project$PlayerTest$suite])),
				A2(
				elm_explorations$test$Test$describe,
				'BoardTest',
				_List_fromArray(
...
_Platform_export({'Test':{'Generated':{'Main1619197617':{'init':author$project$Test$Generated$Main1619197617$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-11002.sock";
